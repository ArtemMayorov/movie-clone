...
export default class FilmCard extends Component {
  ...
  render() {
    const { filmProps, baseImageUrl } = this.props;
    ...
    return (
      <div className="film-card">
        <Row className='card-container'>
          {baseImageUrl ? 
            <Col>
              <img className='card-image' src={`${baseImageUrl}w500${filmProps.backdrop_path}`} alt="testImage" /></Col> 
          ...
          <Col className="card-container-body">
            <Typography className='card-typography'>
              ...
              <div className="card-average">
                <span className="card-average-text">{testObj.vote_average}</span>
              </div>
            </Typography>
